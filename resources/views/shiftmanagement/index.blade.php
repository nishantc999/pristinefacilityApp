...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Shirt Management</div>
            <div class="ps-3">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="ms-auto">
                        @if (ispermission('shift management', 'create'))  
                        <a href="{{route('shiftmanagement.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add New Shift</a>
                       @endif
                    </div>
                    ...
                    <table class="table mb-0" id="example2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$value->shift_hr}} Hr.</td>
                                <td>@foreach ($value->weekday as $weekday)
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        ...
                                        <a href="{{route('shiftmanagement.edit',$value->id)}}" class=""><i class='bx bxs-edit'></i></a>
