            ...
            <div class="col-xl-8 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" method="POST" action="{{ route('shiftmanagement.store') }}" enctype="multipart/form-data">
                            ...
                            @csrf
                              ...
                              <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" value="{{old('name') }}" placeholder="Shift Name" required>
                                @error('name')
                            ...
                            @enderror
                              ...
                              <div class="col-md-6">
                                ...
                                <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" id="description" value="{{old('description') }}" placeholder="Shift description" required>
                                @error('description')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                  </div>
                            @enderror
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control time-picker flatpickr-input active @error('start_time') is-invalid @enderror" name="start_time"  readonly="readonly">
                                    </div>
                                    @error('start_time')
                                    <div class="invalid-feedback" style="display: block">
                                        {{ $message }}
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control time-picker flatpickr-input active @error('end_time') is-invalid @enderror" name="end_time" readonly="readonly">
                                    </div>
                                    @error('end_time')
                                    <div class="invalid-feedback" style="display: block">
                                        {{ $message }}
