        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center gap-1">
                    ...
                    {{-- @if (ispermission('danger permission', 'global city')) --}}
                    {{-- @if (\Session::get('role_id') == 1 || \Session::get('role_id') == 0)
                        ...
                        @php 
                                $global_cities = App\Models\City::where('status', 1)->
                                 when(\Session::has('distributor'), function ($query) {
                                    $distributor_cities = App\Models\User::where('id', \Session::get('distributor'))->value('distributor_cities');
                                    $query->whereIn('id', $distributor_cities);
                                    })->get(['city_name', 'id']);
                                

                                $globalwarehouses = App\Models\Warehouse::
                                 when(Session::has('city'), function ($query) {
                        ...
                        @if (\Session::get('role_id') == 0)
                            ...
                            <li class="nav-item">
                                <form action="{{ route('set_global_distributor') }}" method="POST" id="searchform22">
                                    ...
                                    <select name="distributor" id="setdistributor" class="form-select"
                                        onchange="searchformsubmit22()" data-placeholder="Choose Distributor">
                                        <option></option>
                        ...
                        <li class="nav-item">
                            <form action="{{ route('set_global_city') }}" method="POST" id="searchform">
                                ...
                                <select name="city" id="setglobalcity" class="form-select"
                                    onchange="searchformsubmit()" data-placeholder="Choose Any City">
                                    <option></option>
                                    <option value="-1">All</option>
                        ...
                        <li class="nav-item">
                            <form action="{{ route('set_global_warehouse') }}" method="POST" id="searchform23">
                                ...
                                <select name="warehouse" id="setwarehouse" class="form-select"
                                    onchange="searchformsubmit23()" data-placeholder="Choose Warehouse">
                                    <option></option>
                                    <option value="-1">All</option>
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                    ...
                    {{-- <img src="{{asset('assets/slip/'.auth('web_admin')->user()->profile)}}" class="user-img" alt="user avatar"> --}}
                    <img src="{{ asset('assets/' . auth()->user()->profile) }}" class="user-img" alt="user avatar">
                    <div class="user-info">
