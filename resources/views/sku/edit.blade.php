                        ...
                        enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group" role="group" aria-label="Unit Options">
                                    ...
                                    <button type="button" class="btn btn-outline-success unit-option {{ old('unit', isset($data) ? $data->unit : 'KG') == 'Count' ? 'active' : '' }}" data-value="Count">Count</button>
                                </div>
                                @error('unit')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
