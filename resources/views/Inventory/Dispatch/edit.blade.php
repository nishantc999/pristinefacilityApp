                        ...
                        enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                      <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('sku') is-invalid @enderror" name="dispatchNumber" id="sku" value="{{$data->dispatchNumber }}" {{ $toshow ? 'readonly' : 'disabled' }}>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <button type="button" onclick="removeProduct(this)" class="btn btn-danger" {{ $toshow ? '' : 'disabled' }}><i class='bx bxs-trash' 
                                    ></i></button>
                                </div>
                            </div>
                                @endforeach
                                </div>
                                <button type="button" class="btn btn-primary btn-sm" onclick="addProduct()" {{ $toshow ? '' : 'disabled' }}>Add More
                                    Product</button>
        ...
        productDiv.innerHTML = `
            <div class="col-md-6">
                ...
                <select name="product[]" class="form-select @error('product') is-invalid @enderror" required onchange="updateOptions(this)">
                    ...
                    @foreach ($skus as $sku)
                        <option value="{{ $sku->sku }}">{{ $sku->label }}({{$sku->unit}})</option> 
                    @endforeach
                </select>
            </div>
            <div class="col-md-5">
